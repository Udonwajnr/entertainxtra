    ...
    <div className=''>
      ...
      <section className="py-5">
        <div className=' mt-8 px-10 lg:px-2 flex justify-around flex-wrap'>
            <div className="">
                <div role="status" class="space-y-8 animate-pulse  ">
                    <div class="flex items-center justify-center w-full h-60 max-w-[200px] bg-gray-300 rounded sm:w-96 dark:bg-gray-700">
                    </div>
            ...
            <div className="">
                <div role="status" class="space-y-8 animate-pulse m ">
                    <div class="flex items-center justify-center w-full h-60 max-w-[200px] bg-gray-300 rounded sm:w-96 dark:bg-gray-700">
                    </div>
                    <div class="w-full">
                        <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4"></div>
