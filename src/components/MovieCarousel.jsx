         ...
         <div className='relative'>
                <div className='h-screen relative z-10 flex items-center'>
                    ...
                    <div className='text-white max-w-xl px-8 lg:px-2'>
                        ...
                        <div className='text-white flex space-x-3 mt-5'>
            ...
            <div className='relative'>
                <div className='h-screen relative z-10 flex items-center'>
                    ...
                    <div className='  text-white max-w-xl px-8 lg:px-2'>
                        ...
                        <p className='mt-5'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Qui, reprehenderit at architecto ducimus harum neque recusandae itaque eaque totam sapiente expedita voluptates ipsam ipsum ad doloremque fuga dicta enim. Tempore!</p>
                        <div className='flex space-x-4 lg:gap-x-10 mt-5'>
                            <Link href={'/description'} className='py-2 px-3 flex rounded-md bg-red gap-x-2 items-center text-xl p-2'>
                                 {/* <FaPlay size={25}/> */}
                                Details
                                </Link>
                ...
                <div className='h-screen relative z-10 flex items-center'>
                    ...
                    <div className='  text-white max-w-xl px-8 lg:px-2'>
                        ...
                        <div className='flex space-x-4 mt-5'>
                            <Link href={'/description'} className='py-2 px-3 flex rounded-md bg-red gap-x-2 items-center text-xl'>
                                 {/* <FaPlay size={25}/> */}
                                  Detail
                            </Link>
                            <Link href={'/'} className='py-2 px-3 flex rounded-md bg-red gap-x-2 items-center text-xl bg' >
                                {/* <BiCameraMovie size={25}/> */}
                                 Trailer
                            </Link>
                        </div>
