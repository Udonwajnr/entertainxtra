...
export default function MovieDescription({title,image,year,video_quality,trailer_url,language,length_of_video,description,actors,subtitle_link,file_link,genre,movie,country,uuid}){
  ...
  return(
        ...
        {/* change it to the cloud player */}
            ...
            >
                <button className="bg-red justify-center px-7 lg:px-3 py-2.5 text-xl lg:rounded-md flex items-center gap-x-2 lg:text-xs"><FaShareAlt className='w-7 h-7 lg:w-5 lg:h-5'/> Share</button>
            </RWebShare>
              </div>
        {/* change it to the cloud player */}
            </div>
