    ...
    return(
            ...
            <div className='w-10/12 px-10 lg:px-2 lg:w-full lg:mt-5'>
              ...
              <div className='mt-5 flex gap-x-3 '>
                  <div className='w-3/12 lg:w-6/12'>
                    <h3 className='font-bold text-2xl'>Director</h3>
                    <span>Christopher Nolan</span>
                  </div>
                  
                  <div className='w-3/12 lg:w-6/12'>
                    <h3 className='font-bold text-2xl'>Cast</h3>
                    <span>Christian Bale, Michael Cain, Gary Oldman, Anne Hathway, Tom Hardy, Marion Cotillard</span>
                  </div>
        ...
        {/* change it to the cloud player */}
              <div className='grid grid-cols-3 gap-x-3 lg:gap-x-1 mt-8 justify-between items-center'>
                <Link href={'/play'} className="bg-red justify-center px-7 lg:px-3 lg:rounded-md py-2.5 text-xl flex items-center gap-x-3 lg:text-xs"><BiDownload size={25}/> Download</Link>
                {/* <button to={'/play'} className="bg-[#ff0000]">My List</button> */}
                <button to={'/play'} className="bg-red text-center justify-center px-7 lg:px-3 lg:rounded-md py-2.5 text-xl flex items-center gap-x-2 lg:text-xs"><BiCameraMovie size={25}/> Trailer</button>
                <button to={'/play'} className="bg-red justify-center px-7 lg:px-3 py-2.5 text-xl lg:rounded-md flex items-center gap-x-2 lg:text-xs"><FaShareAlt size={25}/> Share</button>
              </div>
        {/* change it to the cloud player */}
            </div>
